...
斥力猛击: 近战攻击，命中+12，范围为5尺，单一目标，造成(2d8+6)的钝击伤害并附带(2d6)的力场伤害，被命中目标需要进行一次力量对抗，对抗失败被击飞15尺。
...
- 智慧湮灭(7)
  - 伊汐利亚斯可以集中精神与一个距离120尺内能看到(伊汐利亚斯拥有真实视野,以太位面的对象可以被选中,可以被石墙术隔绝)的生物建立心灵链接，除非有心灵屏障阻挡。知识吞噬者伊汐利亚斯将用自己在无尽书库阅读了400年的知识灌输给目标，被选中的目标必须通过一次(DC24)的智力豁免，若豁免失败，将受到强烈的心灵冲击(10d10心灵)，并陷入无尽的信息洪流之中(昏迷状态)。若豁免通过将受到一半的伤害并不会陷入昏迷，并且智力提高至23，持续一小时。同时可以过一个(DC15)历史，DM可以酌情告知一些历史设定/敌人属性/经历。
...
- 空间锚定(7)(持续1天)
  - 在120尺内能看见的地点抛下空间锚，以锚点为中心的1200尺立方区域将被固定。这片区域内的所有传送门都将关闭且在法术持续时间内无法被再次开启。任何能进行位面旅行或开启传送门的法术（例如 异界之门gate 或 位面转移plane shift）如果被用于进入这片区域或离开这片区域的话，都将自动失败。可以通过移动空间锚来移动固定区域。
  - 空间锚拥有20AC，100的生命值，免疫毒素，心灵，非魔法伤害，拥有除力场以外的抗性。如果空间锚血量低于一半，可以进行一次DC20的智力检定，通过后将不再收到锚定影响，如果空间锚被摧毁，魔法旅行与位面旅行将不再收到限制，空间锚无法被解除魔法解除。
...
- 力场监牢(7)
  ...
  - 此法术无法被解除魔法解消，允许被解除魔法解除时需要通过施法属性DC25的检定。
