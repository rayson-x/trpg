...
亡魂面孔: AC25，拥有所有抗性，可以通过一次近战/远程魔法武器攻击破坏，如果用法术攻击，需要造成共计40点以上的伤害才能破坏。

### 动作

---

斥力猛击: 近战攻击，命中+12，范围为5尺，单一目标，造成(2d8+6)的钝击伤害并附带(2d10)的力场伤害，同时将目标击飞15尺。

重力场: 以自身为原点40尺半径球形范围内的重力暂时性地增加了，并导致坠落伤害翻倍，在重力场内移动被视为困难地形，且被强制位移超过10尺时受到2d6钝击伤害。

引力: 拉进以自身为原点40尺半径球形范围的生物与物品。所有处于该范围内的生物必须通过一个体质豁免(DC18)。若豁免失败，会受到4d6的力场伤害，且被拉进20尺，豁免通过收到一半伤害且不会被移动。

斥力: 推开以自身为原点40尺半径球形范围的生物与物品。所有处于该范围内的生物必须通过一个体质豁免(DC18)。若豁免失败，会受到4d6的力场伤害，且被推离20尺，豁免通过收到一半伤害且不会被移动。

引力裂沟: 一道半径40尺球形范围的破坏性能量在施法距离内你能看见的一点为源点形成，并开始拖拽范围内的生物。所有在范围内的生物必须进行一次体质豁免(DC18)检定。若豁免失败，该生物受到2d10点力场伤害并且会被直直拉向能量的中心，并在离中心尽可能近的未被占据的空间停止（哪怕这会让他飞到天上）。若豁免成功，则其受到一半伤害并且不会被拉走。
...
- 智慧湮灭(7)
  - 伊汐利亚斯可以集中精神与一个距离120尺内能看到的生物建立心灵链接，除非有心灵屏障阻挡。知识吞噬者伊汐利亚斯将用自己在无尽书库阅读了400年的知识灌输给目标，被选中的目标必须通过一次(DC24)的智力豁免，若豁免失败，将受到强烈的心灵冲击(10d10心灵)，并陷入无尽的信息洪流之中(昏迷状态)。若豁免通过将受到一半的伤害并不会陷入昏迷，并且智力提高至23，持续一小时。同时可以过一个(DC15)历史，DM可以酌情告知一些历史设定/敌人属性/经历。
